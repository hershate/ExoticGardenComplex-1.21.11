...
public final class ExoticGardenRecipeTypes {
    ...
    public static final RecipeType BREAKING_GRASS = new RecipeType(new NamespacedKey(ExoticGarden.instance, "breaking_grass"), CustomItemStack.create(Material.SHORT_GRASS, "&7破坏草"));
    public static final RecipeType HARVEST_TREE = new RecipeType(new NamespacedKey(ExoticGarden.instance, "harvest_tree"), CustomItemStack.create(Material.OAK_LEAVES, "&a从树木中获得", "", "&r通过种植特定树木获得"));
    public static final RecipeType HARVEST_BUSH = new RecipeType(new NamespacedKey(ExoticGarden.instance, "harvest_bush"), CustomItemStack.create(Material.OAK_LEAVES, "&a从灌木丛中获得", "", "&r通过种植特定灌木丛获得"));
    public static final RecipeType HARVEST_PLANT = new RecipeType(new NamespacedKey(ExoticGarden.instance, "harvest_plant"), CustomItemStack.create(Material.OAK_LEAVES, "&7从特定的植物上收获"));
    ...
    public static final RecipeType BREAK_GRASS = new RecipeType(new NamespacedKey(ExoticGarden.instance, "break_grass"), CustomItemStack.create(Material.TALL_GRASS, "&7破坏杂草获得"));
    public static final RecipeType BREWER = new RecipeType(new NamespacedKey(ExoticGarden.instance, "brewer"), CustomItemStack.create(SkullUtil.getByBase64("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmZiOTg1OTYyZjQ2ZTA1NWY1M2Q4ZWUzNWIxMWI4YTYyZjM5N2RhZDlkYjlmZWFlZmY0ODI5NjMwZDlkOSJ9fX0="), "&b电力酿造机", "", "&7用于制作美酒"));

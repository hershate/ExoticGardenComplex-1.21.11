...
> 2026-08-01 更新：1.3.0 基准等价性断言由 5 项扩至 10 项）
...
| 10 | 基准正确性 | 运行 `benchmark/`，校验新旧算法**等价性断言全 PASS**（match / fits / 进度条门控 / SFItem 缓存 / 能量结算 / SlimefunTag / getItem 缓存 / getByItem 克隆 / onPlace-onEquip 预过滤，共 10 项；`Benchmark.main` 在任一断言失败时退出码 1） |
